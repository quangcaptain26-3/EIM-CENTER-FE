...
import { Banknote, BookOpen, Calendar, GraduationCap } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <KpiCard
          ...
          trend={
            revTrend != null ? { value: revTrend, label: 'So với tháng trước' } : undefined
          }
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-[var(--border-subtle)] dark:bg-[var(--bg-base)]">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-slate-200 text-xs uppercase text-slate-600 dark:border-[var(--border-subtle)]">
                  ...
                  <th className="pb-2 pr-2 text-right">Nợ</th>
            ...
            {!isLoading && !(s?.topDebtors?.length) ? (
              <p className="py-6 text-center text-sm text-slate-500">Không có công nợ</p>
            ) : null}
          </div>
        </section>
